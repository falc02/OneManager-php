...
How to Install: Click the button [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/falc02/OneManager-php) to Deploy a new app, or create an app then deploy via connect to your github fork.  
...
How to Install: New Project -> Import form Github -> paste "https://github.com/falc02/OneManager-php", after done, Show -> In a New Window.  
